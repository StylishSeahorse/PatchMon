...
const CredentialsModal = ({ host, isOpen, onClose, plaintextApiKey }) => {
	...
	const getInstallUrl = () => {
		...
		if (host?.expected_platform === "freebsd" || osType.includes("freebsd"))
			params.set("os", "freebsd");
		if (host?.expected_platform === "openbsd" || osType.includes("openbsd"))
			params.set("os", "openbsd");
		if (
		...
		if (host?.expected_platform === "windows" || osType.includes("windows"))
