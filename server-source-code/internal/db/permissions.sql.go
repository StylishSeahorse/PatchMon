...
SELECT id, role, can_view_dashboard, can_view_hosts, can_manage_hosts, can_view_packages, can_manage_packages, can_view_users, can_manage_users, can_manage_superusers, can_view_reports, can_export_data, can_manage_settings, can_manage_notifications, can_view_notification_logs, can_manage_patching, can_manage_compliance, can_manage_docker, can_manage_alerts, can_manage_automation, can_use_remote_access, can_manage_billing, can_view_session_recordings, created_at, updated_at FROM role_permissions WHERE role = $1
`
...
SELECT id, role, can_view_dashboard, can_view_hosts, can_manage_hosts, can_view_packages, can_manage_packages, can_view_users, can_manage_users, can_manage_superusers, can_view_reports, can_export_data, can_manage_settings, can_manage_notifications, can_view_notification_logs, can_manage_patching, can_manage_compliance, can_manage_docker, can_manage_alerts, can_manage_automation, can_use_remote_access, can_manage_billing, can_view_session_recordings, created_at, updated_at FROM role_permissions ORDER BY role
`
...
RETURNING id, role, can_view_dashboard, can_view_hosts, can_manage_hosts, can_view_packages, can_manage_packages, can_view_users, can_manage_users, can_manage_superusers, can_view_reports, can_export_data, can_manage_settings, can_manage_notifications, can_view_notification_logs, can_manage_patching, can_manage_compliance, can_manage_docker, can_manage_alerts, can_manage_automation, can_use_remote_access, can_manage_billing, can_view_session_recordings, created_at, updated_at
`
