...
func (d *Detector) latestInstalledKernel(runningKernel string) string {
	...
	// Arch reports the installed kernel through pacman rather than any of the
	// file/package sources below, and reports it already resolved, so it is
	// tried first and returned as-is.
